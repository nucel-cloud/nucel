...
pnpm add -D @nucel.cloud/pulumi-react-router-aws
```
...
import adapter from "@nucel.cloud/pulumi-react-router-aws/adapter";
...
import { ReactRouterAwsDeployment } from "@nucel.cloud/pulumi-react-router-aws";
