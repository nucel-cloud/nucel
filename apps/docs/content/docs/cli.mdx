...
```bash tab="pnpm"
pnpm add -g @nucel.cloud/nucel-cli
```

```bash tab="yarn"
yarn global add @nucel.cloud/nucel-cli
```

```bash tab="bun"
bun add -g @nucel.cloud/nucel-cli
```
...
```bash
# Check installation
npm list -g @nucel.cloud/nucel-cli
...
```bash
# Fix npm permissions
sudo npm install -g @nucel.cloud/nucel-cli

# Or use npx
npx @nucel.cloud/nucel-cli deploy
```
